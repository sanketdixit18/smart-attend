          ...
          {step === 'uid' && (
            <motion.div key="uid" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} style={card}>
              ...
              <div style={{ display: 'flex', gap: 0, marginBottom: 28, background: 'rgba(255,184,224,0.15)', borderRadius: 14, padding: 4 }}>
                ...
                <Link href="/uid-login" style={{ flex: 1, padding: '9px', borderRadius: 11, background: 'white', color: 'var(--dark-accent)', fontWeight: 700, fontSize: 14, textDecoration: 'none', textAlign: 'center', display: 'block', boxShadow: '0 2px 8px rgba(190,89,133,0.15)' }}>
                  Student (UID)
                </Link>
              </div>
              ...
              <form onSubmit={handleUIDSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div>
                  ...
                  <input
                    ...
                    required
                    autoFocus
                    style={{ width: '100%', padding: '14px 18px', borderRadius: 14, border: '1.5px solid rgba(255,184,224,0.5)', background: 'rgba(255,255,255,0.8)', fontSize: 20, fontWeight: 700, color: 'var(--text-primary)', outline: 'none', letterSpacing: '0.1em', fontFamily: 'DM Sans, sans-serif', textAlign: 'center' }}
                  />
                  <p style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 8 }}>
                    Your UID is provided by your institution. An OTP will be sent to your registered email.
                  </p>
                </div>
              ...
              {/* Info box */}
              <div style={{ marginTop: 20, padding: '12px 16px', background: 'rgba(236,127,169,0.06)', border: '1px solid rgba(236,127,169,0.15)', borderRadius: 12 }}>
                <p style={{ fontSize: 12, color: 'var(--text-muted)', margin: 0 }}>
                  🔐 Your UID must be registered by your institution. If you get an error, contact your admin.
                </p>
              </div>
